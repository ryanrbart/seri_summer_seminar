...
input_rhessys$output_filename <- "1.5_p301_1"
...
input_tec_data[4,] <- data.frame(1960, 7, 31, 1, "output_current_state", stringsAsFactors=FALSE)
input_tec_data[5,] <- data.frame(1965, 7, 31, 1, "output_current_state", stringsAsFactors=FALSE)
input_tec_data[6,] <- data.frame(1990, 7, 31, 1, "output_current_state", stringsAsFactors=FALSE)
input_tec_data[7,] <- data.frame(1995, 7, 31, 1, "output_current_state", stringsAsFactors=FALSE)
input_tec_data[8,] <- data.frame(2000, 7, 31, 1, "output_current_state", stringsAsFactors=FALSE)
...
world_name_out <- "ws_p301/worldfiles/p301_30m_2canopy_scenario5_treatment1.world"
canopy_default_ID <- 7
reduction_percent <- 8
...
input_rhessys$rhessys_version <- "bin/rhessys5.20.1"
input_rhessys$tec_file <- "ws_p301/tecfiles/p301_fire.tec"
input_rhessys$world_file <- "ws_p301/worldfiles/p301_30m_2canopy_scenario5_treatment1.world"
input_rhessys$world_hdr_prefix <- "p301_30m"
input_rhessys$flow_file <- "ws_p301/flowtables/p301_30m.flow"
input_rhessys$start_date <- "1955 8 1 1"
input_rhessys$end_date <- "1960 8 1 1"
input_rhessys$output_folder <- "ws_p301/out"
input_rhessys$output_filename <- "1.5_p301_2"
input_rhessys$command_options <- c("-b -g -c 1 189 8081 8081")
...
world_name_in <- "ws_p301/worldfiles/p301_30m_2canopy_scenario5_treatment1.world.Y1960M7D31H1.state"
world_name_out <- "ws_p301/worldfiles/p301_30m_2canopy_scenario5_treatment2.world"
canopy_default_ID <- 7
reduction_percent <- 8
...
input_rhessys$rhessys_version <- "bin/rhessys5.20.1"
input_rhessys$tec_file <- "ws_p301/tecfiles/p301_fire.tec"
input_rhessys$world_file <- "ws_p301/worldfiles/p301_30m_2canopy_scenario5_treatment2.world"
input_rhessys$world_hdr_prefix <- "p301_30m"
input_rhessys$flow_file <- "ws_p301/flowtables/p301_30m.flow"
input_rhessys$start_date <- "1960 8 1 1"
input_rhessys$end_date <- "1965 8 1 1"
input_rhessys$output_folder <- "ws_p301/out"
input_rhessys$output_filename <- "1.5_p301_3"
input_rhessys$command_options <- c("-b -g -c 1 189 8081 8081")
...
world_name_in <- "ws_p301/worldfiles/p301_30m_2canopy_scenario5_treatment2.world.Y1965M7D31H1.state"
world_name_out <- "ws_p301/worldfiles/p301_30m_2canopy_scenario5_treatment3.world"
canopy_default_ID <- 7
reduction_percent <- 8
...
input_rhessys$rhessys_version <- "bin/rhessys5.20.1"
input_rhessys$tec_file <- "ws_p301/tecfiles/p301_fire.tec"
input_rhessys$world_file <- "ws_p301/worldfiles/p301_30m_2canopy_scenario5_treatment3.world"
input_rhessys$world_hdr_prefix <- "p301_30m"
input_rhessys$flow_file <- "ws_p301/flowtables/p301_30m.flow"
input_rhessys$start_date <- "1965 8 1 1"
input_rhessys$end_date <- "1990 8 1 1"
input_rhessys$output_folder <- "ws_p301/out"
input_rhessys$output_filename <- "1.5_p301_4"
input_rhessys$command_options <- c("-b -g -c 1 189 8081 8081")
...
world_name_in <- "ws_p301/worldfiles/p301_30m_2canopy_scenario5_treatment3.world.Y1990M7D31H1.state"
world_name_out <- "ws_p301/worldfiles/p301_30m_2canopy_scenario5_treatment4.world"
canopy_default_ID <- 7
reduction_percent <- 8
...
input_rhessys$rhessys_version <- "bin/rhessys5.20.1"
input_rhessys$tec_file <- "ws_p301/tecfiles/p301_fire.tec"
input_rhessys$world_file <- "ws_p301/worldfiles/p301_30m_2canopy_scenario5_treatment4.world"
input_rhessys$world_hdr_prefix <- "p301_30m"
input_rhessys$flow_file <- "ws_p301/flowtables/p301_30m.flow"
input_rhessys$start_date <- "1990 8 1 1"
input_rhessys$end_date <- "1995 8 1 1"
input_rhessys$output_folder <- "ws_p301/out"
input_rhessys$output_filename <- "1.5_p301_5"
input_rhessys$command_options <- c("-b -g -c 1 189 8081 8081")
...
world_name_in <- "ws_p301/worldfiles/p301_30m_2canopy_scenario5_treatment4.world.Y1995M7D31H1.state"
world_name_out <- "ws_p301/worldfiles/p301_30m_2canopy_scenario5_treatment5.world"
canopy_default_ID <- 7
reduction_percent <- 8
...
input_rhessys$rhessys_version <- "bin/rhessys5.20.1"
input_rhessys$tec_file <- "ws_p301/tecfiles/p301_fire.tec"
input_rhessys$world_file <- "ws_p301/worldfiles/p301_30m_2canopy_scenario5_treatment5.world"
input_rhessys$world_hdr_prefix <- "p301_30m"
input_rhessys$flow_file <- "ws_p301/flowtables/p301_30m.flow"
input_rhessys$start_date <- "1995 8 1 1"
input_rhessys$end_date <- "2000 8 1 1"
input_rhessys$output_folder <- "ws_p301/out"
input_rhessys$output_filename <- "1.5_p301_6"
input_rhessys$command_options <- c("-b -g -c 1 189 8081 8081")
...
world_name_in <- "ws_p301/worldfiles/p301_30m_2canopy_scenario5_treatment5.world.Y2000M7D31H1.state"
world_name_out <- "ws_p301/worldfiles/p301_30m_2canopy_scenario5_treatment6.world"
canopy_default_ID <- 7
reduction_percent <- 8
...
input_rhessys$rhessys_version <- "bin/rhessys5.20.1"
input_rhessys$tec_file <- "ws_p301/tecfiles/p301_fire.tec"
input_rhessys$world_file <- "ws_p301/worldfiles/p301_30m_2canopy_scenario5_treatment6.world"
input_rhessys$world_hdr_prefix <- "p301_30m"
input_rhessys$flow_file <- "ws_p301/flowtables/p301_30m.flow"
input_rhessys$start_date <- "2000 8 1 1"
input_rhessys$end_date <- "2021 10 1 1"
input_rhessys$output_folder <- "ws_p301/out"
input_rhessys$output_filename <- "1.5_p301_7"
input_rhessys$command_options <- c("-b -g -c 1 189 8081 8081")
...
pre <- c("ws_p301/out/1.5_p301_1",
         "ws_p301/out/1.5_p301_2",
         "ws_p301/out/1.5_p301_3",
         "ws_p301/out/1.5_p301_4",
         "ws_p301/out/1.5_p301_5",
         "ws_p301/out/1.5_p301_6",
         "ws_p301/out/1.5_p301_7")
...
# Re-export
bd_path <- c("ws_p301/out/1.5_p301_basin.daily")
bdg_path <- c("ws_p301/out/1.5_p301_grow_basin.daily")
cd_path <- c("ws_p301/out/1.5_p301_stratum.daily")
cdg_path <- c("ws_p301/out/1.5_p301_grow_stratum.daily")
